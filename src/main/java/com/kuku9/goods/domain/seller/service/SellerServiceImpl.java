...
public class SellerServiceImpl implements SellerService {
    ...
    public void orderProductStatus(Long productId, CustomUserDetails userDetails) {
        ...
        Product product = findProduct(productId, userDetails);
        if (product == null) {
    ...
    private Product findProduct(Long productId, CustomUserDetails userDetails) {
        return productRepository.findByIdAndSellerId(productId, userDetails.getUser().getId());
    }
